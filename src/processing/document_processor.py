...
def extract_attributes(text: str, filename: str) -> dict:
    default = {"category": "Personal","Name": "Unknown", "vendor": "Unknown", "doc_date": "NONE", "expiry_date": "NONE", "amount": "NONE"}
    if not text.strip():
        return default
...
- Name: person name holding this document(e.g. John Doe, Jane Smith)
